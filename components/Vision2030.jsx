      ...
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        <div className="relative min-h-[460px] overflow-hidden border border-dam-bronze/30">
          ...
          <div className="relative p-8">
            <span className="border border-dam-beige/30 px-4 py-2 text-sm font-bold text-dam-beige">{t.vision2030.badge}</span>
          </div>
        </div>
        <div>
          <SectionTitle title={t.vision2030.title} align="start" tone="dark" dir={t.dir} locale={t.langLabel} />
          <TextAnimate as="p" by="word" animation="blurInUp" dir={t.dir} locale={t.langLabel} className={`text-dam-cream/78 ${t.dir === "rtl" ? "text-2xl leading-[1.9] md:text-3xl md:leading-[1.9]" : "text-lg leading-9"}`}>
            {t.vision2030.body}
          </TextAnimate>
